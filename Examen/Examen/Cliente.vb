Public Class Cliente
    ...
    Private Sub txtNombre_MouseHover(sender As Object, e As EventArgs) Handles txtNombre.MouseHover
        ToolTip1.SetToolTip(txtNombre, "Ingrese el Nombre del Cliente")
    ...
    Private Sub txtApellido_MouseHover(sender As Object, e As EventArgs) Handles txtApellido.MouseHover
        ToolTip1.SetToolTip(txtApellido, "Ingrese el Apellido del Cliente")
        ToolTip1.ToolTipTitle = "Apellido"
        ToolTip1.ToolTipIcon = ToolTipIcon.Info
    End Sub
    ...
    Private Sub txtDireccion_MouseHover(sender As Object, e As EventArgs) Handles txtDireccion.MouseHover
        ...
        ToolTip1.ToolTipTitle = "Dirección"
        ToolTip1.ToolTipIcon = ToolTipIcon.Info
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            If Me.ValidateChildren And IsNumeric(txtNombre.Text) = False And txtNombre.Text <> String.Empty And txtDireccion.Text <> String.Empty And txtID.Text <> String.Empty And IsNumeric(txtID.Text) = True And txtApellido.Text <> String.Empty Then
